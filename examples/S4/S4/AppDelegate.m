...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    EvenOddController *evenOdd = [[EvenOddController alloc] init];
    evenOdd.title = @"EvenOdd";
    DiscountController *discount = [[DiscountController alloc] init];
    discount.title = @"%";
    InterestController *interest = [[InterestController alloc] init];
    interest.title = @"$";
    OlympicController *olympic = [[OlympicController alloc] init];
    olympic.title = @"00000";
    
    NSArray *ctlrs = [[NSArray alloc] initWithObjects:evenOdd,
                      discount, interest, olympic, nil];
    [tab setViewControllers:ctlrs animated:YES];
